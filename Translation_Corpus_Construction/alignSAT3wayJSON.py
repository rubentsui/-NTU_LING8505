...
from dp_utils3way import make_alignment_types, make_alignment_types_fixed_source, make_doc_embedding, vecalign, yield_overlaps
    # read_alignments, read_in_embeddings, 
...
if __name__ == '__main__':
    ...
    fn_json = f'{source_folder}/SA.2025.en-zh.json'
    CORPUS = []
    with open(fn_json, 'r', encoding='utf-8') as fi:
